...
router.get('/', function(req, res) {
	request('https://jsonplaceholder.typicode.com/comments', {json: true}, function (err, requestRes, body){
		if (err) {
			// We got an error
			res.send(err);
		} else {
...
router.get('/:id', function(req, res) {
	request(`https://jsonplaceholder.typicode.com/comments/${req.params.id}`, {json: true}, function (err, requestRes, body){
		if (err) {
			// We got an error
			res.send(err);
		} else {
